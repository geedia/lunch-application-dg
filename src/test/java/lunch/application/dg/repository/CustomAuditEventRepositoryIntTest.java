package lunch.application.dg.repository;

import lunch.application.dg.LunchApplicationDgApp;
import lunch.application.dg.config.Constants;
import lunch.application.dg.config.audit.AuditEventConverter;
import lunch.application.dg.domain.PersistentAuditEvent;
...
import static lunch.application.dg.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
